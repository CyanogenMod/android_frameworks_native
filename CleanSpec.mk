...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/obj/SHARED_LIBRARIES/libsystem_server_intermediates)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/obj/EXECUTABLES/bootanimation_intermediates)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/obj/EXECUTABLES/surfaceflinger_intermediates)
